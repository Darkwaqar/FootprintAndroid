 ...
 * @author amyu
 *
 * {@link WaveView#mDropBounceHorizontalAnimator} ã�¨ {@link WaveView#mDropVertexAnimator} ã�«ã‚»ãƒƒãƒˆã�™ã‚‹Interpolator
 * WavePullToRefresh/DropBounceInterpolator.gcxã�«ã‚°ãƒ©ãƒ•ã�®è©³ç´°
 */
