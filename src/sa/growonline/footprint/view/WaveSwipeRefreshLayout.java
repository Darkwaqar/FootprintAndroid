...
import sa.growonline.footprint.view.utils.waveprogress.AnimationImageView;
import sa.growonline.footprint.view.utils.waveprogress.DisplayUtil;
import sa.growonline.footprint.view.utils.waveprogress.MaterialProgressDrawable;
import sa.growonline.footprint.view.utils.waveprogress.WaveView;
...
public class WaveSwipeRefreshLayout extends ViewGroup implements ViewTreeObserver.OnPreDrawListener {
  ...
  /**
   * {@link WaveSwipeRefreshLayout#mAnimateToCorrectPosition } ã�«ã‚»ãƒƒãƒˆã�™ã‚‹Interpolator
   */
  ...
  /**
   * {@link WaveSwipeRefreshLayout#mListener} ã�«é€šçŸ¥ã�™ã‚‹ã�‹ã�©ã�†ã�‹ã�®Flag
   */
  ...
  private void onAppearPhase(float move1, float move2) {
    //ã�™ã�§ã�«æ��ç”»ã�•ã‚Œã�¦ã�„ã‚‹æ³¢ã�«å¯¾ã�—ã�¦è¿½åŠ ã�§å††ã‚’æ��ç”»ã�™ã‚‹
  ...
  /**
   * @param refreshing Refreshã�®çŠ¶æ…‹
   * @param notify Listenerã�«é€šçŸ¥ã�™ã‚‹ã�‹ã�©ã�†ã�‹
   */
  ...
  /**
   * @param colors ã‚»ãƒƒãƒˆã�™ã‚‹Coloré�”
   */
  ...
  /**
   * @param refreshing {@link WaveSwipeRefreshLayout#mState} ã�®ã‚»ãƒƒãƒˆ
   */
