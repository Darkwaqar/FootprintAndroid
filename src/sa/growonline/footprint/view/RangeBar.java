...
import sa.growonline.footprint.view.utils.Bar;
import sa.growonline.footprint.view.utils.ConnectingLine;
import sa.growonline.footprint.view.utils.IRangeBarFormatter;
 ...
 * {@link sa.growonline.footprint.view.RangeBar.OnRangeBarChangeListener} to be notified when the pins
 * have
 * been moved.
 */
public class RangeBar extends View {
    ...
    public void setUpRangeBar(float tickStart, float tickEnd, float tickInterval){
        this.mTickStart = tickStart;
        this.mTickEnd = tickEnd;
        this.mTickInterval = tickInterval;

        this.setTickStart(tickStart);
        this.setTickEnd(tickEnd);
