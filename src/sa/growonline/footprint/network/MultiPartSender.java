...
public class MultiPartSender extends NetworkUtils
{
	...
	public String sendPostStringUsingMultiPart(Activity mContext, String URL, HashMap<String, String> fields, boolean isSaveCookie) throws Exception
	{
		HttpURLConnection httpURLConnection = getUrlConnection(ZuniConstants.BASE_URL + URL, HTTP_POST, APPLICATION_MULTIPART, mBoundary);
		mBoundary = END_REQUEST + mBoundary;
