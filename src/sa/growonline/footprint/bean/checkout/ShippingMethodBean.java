...
public class ShippingMethodBean {
    ...
    @Expose
    private sa.growonline.footprint.bean.checkout.ShippingOption ShippingOption;
     ...
     *     The ShippingOption
     */
    public sa.growonline.footprint.bean.checkout.ShippingOption getShippingOption() {
     ...
     *     The ShippingOption
     */
    public void setShippingOption(sa.growonline.footprint.bean.checkout.ShippingOption ShippingOption) {
